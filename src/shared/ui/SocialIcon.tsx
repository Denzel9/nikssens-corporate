...
type SocialIconId = "telegram" | "vk" | "instagram" | "youtube";
...
const icons: Record<SocialIconId, typeof TelegramIcon> = {
...
type SocialIconProps = SvgIconProps & {
  id: SocialIconId;
};

export function SocialIcon({ id, ...props }: SocialIconProps) {
  const Icon = icons[id];
