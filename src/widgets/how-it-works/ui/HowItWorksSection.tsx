...
const steps = [
  { n: "01", title: "Объявление", text: "С описание задачи и сроков" },
  { n: "02", title: "Отклик", text: "Сопроводительное письмо" },
...
const perspectives = [
  {
    ...
    items: [
      ...
      "Текущие задачи и календарь",
      "Исполнителей и публикации",
      "Команду с ролями: менеджеры бренда и другие исполнители",
    ],
  },
  {
    title: "Исполнитель видит",
    items: [
      "Ленту объявлений и гибкий поиск",
      "Статус своих откликов",
      "Задачи, дедлайны и календарь",
  ...
  },
  {
    ...
    items: [
      "Переключение между связанными профилями и компаниями",
      "Роли Владелец и Менеджер в рабочем пространстве",
      "Несколько задач на одно объявление — у каждой свой исполнитель",
      "Дашборд, календарь, публикации и архив",
    ],
  },
] as const;
